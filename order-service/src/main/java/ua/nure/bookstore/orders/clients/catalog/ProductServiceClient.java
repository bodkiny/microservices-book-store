package ua.nure.bookstore.orders.clients.catalog;
...
public class ProductServiceClient {
    public static final Logger log = LoggerFactory.getLogger(ProductServiceClient.class);
    ...
    public Optional<Product> getProductByCode(String code) {
        ...
        return Optional.ofNullable(fetchedProduct);
    }
