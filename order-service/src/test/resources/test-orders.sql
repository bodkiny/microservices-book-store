...
insert into orders (id, order_number, username,
                    ...
                    status, comments)
values (1, 'order-123', 'user', 'John Doe', 'johnD@gmail.com', '666666666', '123 Main Str', 'Apt 1', 'Dallas', 'TX', '75001',
        'USA', 'NEW', null),
       (2, 'order-456', 'user', 'Rachel Smith', 'rachelS@gmail.com', '777777777', '13 Madison Str', 'Apt 43', 'Los Angeles', 'CA',
        '90001', 'USA', 'NEW', null);
